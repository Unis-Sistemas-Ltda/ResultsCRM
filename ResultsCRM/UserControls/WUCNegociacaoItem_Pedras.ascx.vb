Public Class WUCNegociacaoItem_Pedras
            ...
            If Not String.IsNullOrEmpty(Session("SCodItemPesquisado")) Then
                ...
                If Session("SAlterouCodItem") = "S" Then
                    If TxtCodItem.Text <> Session("SCodItemPesquisado") Then
                        ...
                        CodItemMudou()
                    End If
                    'If DdlLote.SelectedValue <> Session("SReferenciaPesquisada") Then
                    ...
                    '    objItemReferencia.FillDropDown(DdlLote, True, "(selecione)")
                    '    DdlLote.SelectedValue = Session("SReferenciaPesquisada")
                    'End If
    ...
    Private Sub CodItemMudou()
        ...
        Try
            ...
            If Not String.IsNullOrEmpty(TxtCodItem.Text) Then
                ...
                Dim objItemLote As New UCLItemLote(StrConexao)
                Session("ItemLote") = TxtCodItem.Text
                Session("CodNatOp") = ObjNegociacao.CodNaturOper
                objItemLote.CodItem = TxtCodItem.Text
                BtnFiltrarLotes.Visible = True
                objItemLote.Empresa = Session("GlEmpresa")
                objItemLote.FillDropDown(DdlLote, True, "(selecione)")
    ...
    Private Function CarregaObjeto(ByRef objNegociacaoItem As UCLNegociacaoItem) As UCLNegociacaoItem
        ...
        objNegociacaoItem.Lote = DdlLote.SelectedValue
    ...
    Protected Sub CarregaFormulario()
        ...
        Dim objItemLote As New UCLItemLote(StrConexao)
        objItemLote.CodItem = TxtCodItem.Text
        objItemLote.Empresa = objNegociacaoItem.Empresa
        objItemLote.FillDropDown(DdlLote, True, "(selecione)")

        DdlLote.SelectedValue = objNegociacaoItem.Lote
        Session("SCodItemPesquisado") = TxtCodItem.Text
        'Session("SReferenciaPesquisada") = DdlLote.SelectedValue
        Call CarregaUnidades()
    ...
    Protected Sub DdlLote_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DdlLote.SelectedIndexChanged
        Try
            Dim objItemLote As New UCLItemLote(StrConexao)
            objItemLote.CodItem = TxtCodItem.Text
            objItemLote.Empresa = Session("GlEmpresa")
            TxtQuantidade.Text = objItemLote.QtdeItemPreco(DdlLote.SelectedValue).ToString("F4")
