<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUCAcao.ascx.vb" Inherits="ResultsCRM.WUCAcao" %>

<link href="../ResultsCRM.css" rel="stylesheet" type="text/css" />
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
<div class="TituloCadastro">
    Detalhe da Ação / Barreira Implementada</div>
<table class="TextoCadastro" style="width:100%;">
    ...
    <tr>
        ...
        <td class="CelulaCampoCadastro">
            <asp:Label ID="LblCodAcao" runat="server" Font-Bold="True"></asp:Label>
        </td>
    </tr>
    <tr>
        <td style="text-align: right">
    ...
    <tr>
        <td style="text-align: right">
            Tipo:</td>
        <td class="CelulaCampoCadastro">
            <asp:DropDownList ID="DdlTipoAcao" runat="server" CssClass="CampoCadastro" 
                Width="125px">
                <asp:ListItem Value="1">Preventiva</asp:ListItem>
                <asp:ListItem Value="2">Corretiva</asp:ListItem>
            </asp:DropDownList>
        </td>
    </tr>
    <tr>
