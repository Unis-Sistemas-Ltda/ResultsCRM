Public Partial Class WUCAtendimentoEmail
    ...
    Private Sub CarregaFormulario()
        ...
        If objEmail.Buscar() Then
            ...
            If Not String.IsNullOrEmpty(LblCaminhoAnexo1.Text) Then
                ...
                LblAnexo1.NavigateUrl = DominioAnexoEmail + LblAnexo1.Text
            ...
            If Not String.IsNullOrEmpty(LblCaminhoAnexo2.Text) Then
                ...
                LblAnexo2.NavigateUrl = DominioAnexoEmail + LblAnexo2.Text
            ...
            If Not String.IsNullOrEmpty(LblCaminhoAnexo3.Text) Then
                ...
                LblAnexo3.NavigateUrl = DominioAnexoEmail + LblAnexo3.Text
    ...
    Private ReadOnly Property CaminhoFisicoAnexo1() As String
        Get
            ...
            If Not String.IsNullOrEmpty(FUAnexo1.FileName) Then
                ...
                arquivoanexo = objParametrosManutencao.GetConteudo("caminho_anexo_email") + "\" + LblNrEmail.Text.PadLeft(7, "0") + "_" + arquivoanexo
            Else
