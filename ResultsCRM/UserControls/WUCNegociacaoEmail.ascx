<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUCNegociacaoEmail.ascx.vb" Inherits="ResultsCRM.WUCNegociacaoEmail" %>
...
<table class="TextoCadastro_BGBranco" 
    ...
    <tr>
        <td colspan="4" class="SubTituloMovimento">
            E-mail<br />
            <br />
        </td>
    </tr>
...
&nbsp;<asp:Label ID="LblEnviadoData" runat="server" Height="16px" Font-Bold="False"></asp:Label>
            <asp:Label ID="LblEnviadoHora" runat="server" Height="16px" Font-Bold="False"></asp:Label>
        </td>
    </tr>
    <tr>
        <td style="text-align: right">
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <asp:HyperLink ID="LblAnexo1" runat="server">[LblAnexo1]</asp:HyperLink>
            <br />
            ...
            <asp:ImageButton ID="BtnExcluirAnexo2" runat="server" 
                ...
                Width="13px" />
            <asp:HyperLink ID="LblAnexo2" runat="server">[LblAnexo2]</asp:HyperLink>
            <br />
            ...
            <asp:ImageButton ID="BtnExcluirAnexo3" runat="server" 
                ImageUrl="~/Imagens/BtnExcluir.png" ToolTip="Excluir Anexo" Visible="False" 
                Width="13px" />
            <asp:HyperLink ID="LblAnexo3" runat="server">[LblAnexo3]</asp:HyperLink>
        </td>
    </tr>
    <tr>
        <td style="text-align: right; vertical-align: top">
