...
<table class="TextoCadastro_BGBranco" 
    ...
    <tr>
        <td style="border-width: 1px; border-color: #C0C0C0; border-top-style: solid; border-left-style: solid;">
            R$ Fábrica:</td>
        <td class="CelulaCampoCadastro" 
            style="border-width: 1px; border-color: #C0C0C0; border-top-style: solid;">
            % Desc.Com.1:</td>
        <td class="CelulaCampoCadastro" 
            style="border-width: 1px; border-color: #C0C0C0; border-top-style: solid;">
            % Desc.Com.2:</td>
        ...
        <td class="CelulaCampoCadastro" 
            ...
            % Desc.Com.4:</td>
        <td class="CelulaCampoCadastro" 
            style="border-width: 1px; border-color: #C0C0C0; border-top-style: solid; border-right-style: solid;">
            % Repasse:</td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="border-width: 1px; border-color: #C0C0C0; border-left-style: solid; border-bottom-style: solid;">
            R$ 
...
&nbsp;<asp:Label ID="LblRecurso" runat="server" Font-Bold="True" Text="0,0000"></asp:Label>
        ...
        <td class="CelulaCampoCadastro" 
            ...
            style="border-width: 1px; border-color: #C0C0C0; border-bottom-style: solid;">
           R$ <asp:Label ID="LblICMS" runat="server" Font-Bold="True">0,0000</asp:Label>
            </td>
        <td class="CelulaCampoCadastro" 
...
&nbsp;<asp:Label ID="LblIPI" runat="server" Font-Bold="True">0,0000</asp:Label>
    ...
    <tr>
        ...
        <td class="CelulaCampoCadastro" style="text-align: right">
            &nbsp;</td>
        <td class="CelulaCampoCadastro" colspan="2" style="text-align: right">
            R$ Desc. Nota:</td>
        <td class="CelulaCampoCadastro">
