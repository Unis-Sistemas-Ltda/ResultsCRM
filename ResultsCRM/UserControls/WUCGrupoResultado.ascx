<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUCGrupoResultado.ascx.vb" Inherits="ResultsCRM.WUCGrupoResultado" %>
...
<table class="TextoCadastro" style="width:100%;">
    ...
    <tr>
        ...
        <td class="CelulaCampoCadastro">
            <asp:Label ID="LblCodGrupoResultado" runat="server" Font-Bold="True"></asp:Label>
        </td>
    </tr>
    <tr>
        <td style="text-align: right">
