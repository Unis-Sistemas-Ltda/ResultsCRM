<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUCClienteTEFLoja.ascx.vb" Inherits="ResultsCRM.WUCClienteTEFLoja" %>

<script language="jscript" src="../ResultsCRM.js" type="text/jscript"> </script>
...
<table cellpadding="1" cellspacing="1" class="TextoCadastro" 
    ...
    style="padding: 0px; margin: 0px; left: 0px; top: 0px; width: 100%; border-collapse: collapse; ">
    <tr>
    ...
    <tr>
        <td class="Titulo2" colspan="3" style="font-size: 10pt">
            Dados da 
            empresa fornecedora do sistema utilizado no caixa da loja</td>
    </tr>
    <tr>
        <td align="right">
    ...
    <tr>
     ...
     <tr>
        <td colspan="3" class="Titulo2" style="font-size: 10pt">
  ...
  order by t.sequencia">
    ...
    <tr>
        <td class="SubTitulo" colspan="3" style="font-size: 10pt">
            Clique abaixo em Confirmar Dados para salvar os dados.</td>
    </tr>
    <tr>
        <td align="right">
