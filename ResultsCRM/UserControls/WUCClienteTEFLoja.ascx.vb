Public Class WUCClienteTEFLoja
    ...
    Protected Sub RecuperaDados()
        Dim Dt As DataTable
        ObjEmitente = New UCLEmitente(StrConexao)
    ...
    Protected Sub CarregaEstado()
        ...
        objEstado.CodPais = 1
        objEstado.FillDropDown(DdlEstado, True, "(UF)", UCLEstado.Tipo.Sigla)
        objEstado.FillDropDown(DdlEstadoCrf, True, "(UF)", UCLEstado.Tipo.Sigla)
    End Sub
    ...
    Protected Sub CarregaCidade()
        ...
        objCidade.FillDropDown(DdlCidade, True, "(selecione a cidade)")
    End Sub
    ...
    Protected Sub IncluirDados()
        ...
        Try
            ...
            LblErro.Text = "O Cadastro do estabelecimento foi inserido com sucesso. "
    ...
    Protected Sub GravarDados()
        ...
        Try
            ...
            LblErro.Text = "O Cadastro do estabelecimento foi atualizado com sucesso. "
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
