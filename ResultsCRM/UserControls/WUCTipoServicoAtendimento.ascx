<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUCTipoServicoAtendimento.ascx.vb" Inherits="ResultsCRM.WUCTipoServicoAtendimento" %>
<%@ Register src="../OutrosControles/TextBoxInteiro.ascx" tagname="TextBoxInteiro" tagprefix="uc1" %>
<link href="../ResultsCRM.css" rel="stylesheet" type="text/css" />
<div class="TituloCadastro">Detalhe do Tipo de Serviço do Atendimento</div>
<table class="TextoCadastro" style="width:100%;">
    ...
    <tr>
        ...
        <td class="CelulaCampoCadastro">
            <asp:Label ID="LblCodTipoServico" runat="server" Font-Bold="True"></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
