<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WGPosVendaFinanceiroLiquidados.aspx.vb" Inherits="ResultsCRM.WGPosVendaFinanceiroLiquidados" %>
...
<body>
    ...
    <div class="TextoCadastro_BGBranco" style="font-weight: bold">
        ...
        HISTÓRICO FINANCEIRO - TÍTULOS LIQUIDADOS<br />
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            CellPadding="4" CssClass="TextoCadastro_BGBranco" DataSourceID="SqlDataSource1" 
            EmptyDataText="Nenhum título liquidado encontrado." 
   ...
   WHERE ((es.tipo	= 3 and titulo_cr.situacao &lt;&gt; 4) or es.tipo &lt;&gt; 3 )
	  ...
	  AND (( titulo_cr.valor_saldo &lt;= 0 ) OR  
         ( titulo_cr.valor_recebido &gt; 0 )) AND  
         titulo_cr.situacao &lt;&gt; 6   
