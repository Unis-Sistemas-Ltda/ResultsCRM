Imports System.IO
Public Class WFRelSLAComparativoAgendamento
    ...
    Private Sub AplicaFiltro()
        ...
        If Not isValidDate(TxtDataEncerramentoI.Text) Then
            LblErro.Text += "Preencha corretamente o início do período de agendamento.<br/>"
        End If
        If Not isValidDate(TxtDataEncerramentoF.Text) Then
            LblErro.Text += "Preencha corretamente o fim do período de agendamento.<br/>"
        End If
