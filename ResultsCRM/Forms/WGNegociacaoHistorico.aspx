<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WGNegociacaoHistorico.aspx.vb" Inherits="ResultsCRM.WGNegociacaoHistorico" %>
    ...
    order by data_visita, nome_cliente, seq_visita;">
                            <SelectParameters>
                                ...
                                <asp:SessionParameter ConvertEmptyStringToNull="False" DbType="String" 
                                    Name=":estabelecimento" SessionField="SEstabelecimentoNegociacao" />
                                <asp:SessionParameter ConvertEmptyStringToNull="False" DbType="String" 
                                    Name=":negociacao" SessionField="SCodNegociacao" />
                            </SelectParameters>
                        </asp:SqlDataSource>
