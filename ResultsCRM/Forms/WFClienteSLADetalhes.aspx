<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFClienteSLADetalhes.aspx.vb" Inherits="ResultsCRM.WFClienteSLADetalhes" %>
...
<body style="margin:0px">
    ...
    <div>
        ...
        <asp:Menu ID="MnuTabs" runat="server" Orientation="Horizontal" Font-Names="Verdana" 
            ...
            <Items>
                <asp:MenuItem Text=" SLA " 
                    
                    Value="WFClienteSLA.aspx"></asp:MenuItem>
            </Items>
        </asp:Menu>
        ...
        <asp:Button ID="BtnVoltar" runat="server" CssClass="Botao" Text="Voltar" />
            ...
            <tr>
                <td style="border: thin ridge #CCCCCC; width: 100%; height: 417px" colspan="2">
