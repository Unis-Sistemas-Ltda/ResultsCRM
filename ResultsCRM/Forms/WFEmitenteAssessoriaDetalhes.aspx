<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFEmitenteAssessoriaDetalhes.aspx.vb" Inherits="ResultsCRM.WFEmitenteAssessoriaDetalhes" %>
            ...
            <td style="padding: 0px; margin: 0px; border-style: solid none solid none; border-width: 1px;
                ...
                <asp:Menu ID="MnuTabs" runat="server" Orientation="Horizontal" Font-Names="Verdana"
                    ...
                    <StaticMenuItemStyle ForeColor="#333333" BorderStyle="None" HorizontalPadding="5px"
                        VerticalPadding="5px" />
                    <Items>
                        <asp:MenuItem Selected="True" Text="Assessoria" 
                            Value="WFEmitenteAssessoria.aspx"></asp:MenuItem>
                        <asp:MenuItem Text="Etapas" Value="WGEmitenteAssessoriaEtapa.aspx"></asp:MenuItem>
                        <asp:MenuItem Text="Follow-Up" Value="WGEmitenteAssessoriaFollowUp.aspx">
                        </asp:MenuItem>
                        <asp:MenuItem Text="Voltar" Value="Voltar" NavigateUrl="WGClienteAssessoria.aspx"></asp:MenuItem>
                    </Items>
                </asp:Menu>
            </td>
        </tr>
        <tr>
            <td style="width: 50%; height: 425px">
