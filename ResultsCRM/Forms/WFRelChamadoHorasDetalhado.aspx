<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFRelChamadoHorasDetalhado.aspx.vb" Inherits="ResultsCRM.WFRelChamadoHorasDetalhado" %>
                            ...
                            <asp:TemplateField HeaderText="Cliente" SortExpression="nome_emitente">
                                ...
                                <div style="font-size:7pt">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                        ...
                                        SelectCommand="call sp_rel_chamados_hora(:empresa, :cod_emitente, :nome_emitente, :abertura_i, :abertura_f, :encerramento_i, :encerramento_f,:contrato, :cod_tipo_cobranca,2)">
                                        <SelectParameters>
            ...
            <tr>
                <td colspan="5">
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                        ...
                        SelectCommand="call sp_rel_chamados_hora(:empresa, :cod_emitente, :nome_emitente, :abertura_i, :abertura_f, :encerramento_i, :encerramento_f, :contrato, :cod_tipo_cobranca,  1)">
                        <SelectParameters>
