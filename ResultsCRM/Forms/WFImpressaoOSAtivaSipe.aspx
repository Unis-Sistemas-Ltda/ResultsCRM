<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFImpressaoOSAtivaSipe.aspx.vb" Inherits="ResultsCRM.WFImpressaoOSAtivaSipe" %>
        ...
        <table style="width:750px; color: #000000; font-size: 10pt; font-family: Arial, Helvetica, sans-serif;" 
            ...
            <tr>
                ...
                <td colspan="2" rowspan="3" 
                    style="border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #CCCCCC" class="auto-style1">
...
&nbsp;/
            ...
            <tr>
                <td colspan="3" style="text-align: left; font-size: 10pt" rowspan="4">
...
&nbsp;/
                ...
                &nbsp;- CEP:<asp:Label ID="LblCEP" runat="server"></asp:Label>
                 ...
                 <td style="border-width: 1px; border-color: #CCCCCC; text-align: left; border-left-style: solid; vertical-align: bottom; font-size: 10pt; height: 24px; border-right-style: solid;" 
                    colspan="2">
                     Data:<br />
                     Início ____/____/____&nbsp;&nbsp;&nbsp;&nbsp; Fim____/____/____</td>
            </tr>
            <tr>
                <td style="border-width: 1px; border-color: #CCCCCC; text-align: left; border-left-style: solid; vertical-align: bottom; font-size: 10pt; height: 24px; border-right-style: solid;" 
                    colspan="2">
                    Hora&nbsp;chegada.:_____:_____</td>
            </tr>
            <tr>
                <td style="border-width: 1px; border-color: #CCCCCC; text-align: left; border-left-style: solid; vertical-align: bottom; font-size: 10pt; height: 24px; border-right-style: solid;" 
                    colspan="2">
                    Hora&nbsp;início....:_____:_____&nbsp;Fim.:_____:_____</td>
            </tr>
            <tr>
                <td style="border-width: 1px; border-color: #CCCCCC; text-align: left; border-left-style: solid; border-bottom-style: solid; vertical-align: top; font-size: 8pt; height: 24px; border-right-style: solid;" 
                    colspan="2">
            ...
            <tr>
                <td colspan="5" style="border-width: 1px; border-color: #999999; border-top-style: solid;">EQUIPAMENTOS DA OS</td>
            </tr>
            <tr>
                <td colspan="5">
                    <asp:GridView ID="GridView1" runat="server" CssClass="TextoCadastro_BGBranco" 
                        ForeColor="Black" Width="100%" Font-Size="10pt" Font-Names="Arial">
                        <RowStyle Height="28px" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" />
            ...
            <tr>
                <td colspan="5">
                    ...
                    <br />
                    Necessário Retorno:&nbsp;
                    <asp:CheckBox ID="chkRetornoSim" runat="server" Text="Sim"/>&nbsp;&nbsp;
                    <asp:CheckBox ID="chkRetornoNao" runat="server" Text="Não"/>
                    <br />
