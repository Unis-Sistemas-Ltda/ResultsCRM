<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WGFalta.aspx.vb" Inherits="ResultsCRM.WGFalta" %>
...
<body>
    ...
    <div>
        ...
        <asp:TextBox ID="TxtDataI" runat="server" CssClass="CampoCadastro" Width="75px"></asp:TextBox><ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" 
        ...
        <asp:TextBox ID="TxtDataF" runat="server" CssClass="CampoCadastro" Width="75px"></asp:TextBox><ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" 
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton ID="ImageButton2" runat="server" CommandName="ALTERAR" 
                            ...
                            CommandArgument='<%# Eval("cod_falta") %>' 
                            ToolTip="Editar dados do registro" />
                    </ItemTemplate>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton ID="ImageButton3" runat="server" 
                            CommandArgument='<%# Eval("cod_falta") %>' CommandName="EXCLUIR" 
 ...
 order by data_falta desc, cod_falta asc">
            <SelectParameters>
