<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WGGrupoProblema.aspx.vb" Inherits="ResultsCRM.WGGrupoProblema" %>
...
<body>
    ...
    <div class="TituloCadastro">
        Cadastro de Grupos de Problemas 
        / Categorias de Modo de Falha</div>
    <div>
    ...
    <div style="text-align: right">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:BoundField DataField="cod_grupo" HeaderText="Código" ReadOnly="True" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="select cod_grupo, descricao
   from grupo_problema
