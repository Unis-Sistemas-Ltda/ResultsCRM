<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFRelNegociacaoFunil.aspx.vb" Inherits="ResultsCRM.WFRelNegociacaoFunil" %>
...
<body>
    ...
    <div class="TituloRelatorio">Relatório de Negociação por Funil de Vendas</div>
    <table style="width:100%;" class="TextoCadastro">
        ...
        <tr>
            <td>
                Etapa Inicial:</td>
            <td class="CelulaCampoCadastro">
                <asp:DropDownList ID="ddlEtapaInicial" runat="server" CssClass="CampoCadastro" 
                    Width="300px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td>
                Etapa Final:</td>
            <td class="CelulaCampoCadastro">
                <asp:DropDownList ID="ddlEtapaFinal" runat="server" CssClass="CampoCadastro" 
                    Width="300px">
                </asp:DropDownList>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="text-align: left">
                <asp:DropDownList ID="DdlModelo" runat="server" AutoPostBack="True" 
                    ...
                    <asp:ListItem Value="3">Resumido</asp:ListItem>
