<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFProblemaDetalhes.aspx.vb" Inherits="ResultsCRM.WFProblemaDetalhes" %>
       ...
       <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td class="TituloCadastro">
                    Cadastro de Problemas / Modos de Falha</td>
            </tr>
            <tr>
        ...
        <asp:Menu ID="MnuTabs" runat="server" Orientation="Horizontal" Font-Names="Verdana" 
            ...
            <Items>
                <asp:MenuItem Selected="True" Text="Problema" 
                    Value="WFProblema.aspx"></asp:MenuItem>
                <asp:MenuItem Text="Causas" Value="WGProblemaCausas.aspx"></asp:MenuItem>
                <asp:MenuItem Text="Voltar" 
                    Value="WGProblema.aspx" NavigateUrl="WGProblema.aspx"></asp:MenuItem>
            </Items>
        </asp:Menu>
