<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WGAtendimentoEfeito.aspx.vb" Inherits="ResultsCRM.WGAtendimentoEfeito" %>
...
&nbsp;<asp:Button ID="BtnIncluir" runat="server" Text="Incluir" />
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Efeito" SortExpression="descricao1">
                    <ItemTemplate>
                        <asp:Label ID="Label5" runat="server" Text='<%# Bind("descricao1") %>'></asp:Label>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="select cp.seq_problema, e.cod_problema, e.assunto, ca.cod_causa, ca.descricao, ce.cod_efeito, ce.descricao
