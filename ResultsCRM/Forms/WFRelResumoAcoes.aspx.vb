...
Partial Public Class WFRelResumoAcoes
    ...
    Protected Sub CarregaGrid()
        ...
        strSql += "select tt.cod_acao acao, tt.descricao descricao, count(tt.cod_acao) qtd_acao, count(distinct(tt.cod_emitente)) qtd_empresa FROM ("
        strSql += "select a.cod_acao acao, a.descricao , f.cod_acao, f.cod_emitente, n.cod_negociacao_cliente, f.seq_follow_up, f.cod_usuario  "
        ...
        End If
        'strSql += " group by a.cod_acao, a.descricao"
        strSql += " UNION ALL "

        strSql += "select distinct a.cod_acao acao, a.descricao , f.cod_acao, C.cod_emitente, f.cod_chamado, f.seq_follow_up, f.cod_usuario  "
        ...
        End If
        strSql += " ) as tt"
        strSql += " group by tt.cod_acao, tt.descricao"
        strSql += " order by tt.descricao"
