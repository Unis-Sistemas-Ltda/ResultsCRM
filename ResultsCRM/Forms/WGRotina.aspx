<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WGRotina.aspx.vb" Inherits="ResultsCRM.WGRotina" %>
...
<body>
    ...
    <div style="text-align: right">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:BoundField DataField="cod_rotina" HeaderText="Código" ReadOnly="True" 
                    SortExpression="cod_rotina">
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton ID="ImageButton1" runat="server" 
                            CommandArgument='<%# Eval("cod_rotina") %>' CommandName="ALTERAR" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="select cod_rotina, nome
   from rotina
