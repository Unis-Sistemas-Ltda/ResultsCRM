...
Partial Public Class WFRelAcoesEmpresa
    ...
    Protected Sub CarregaGrid()
        ...
        strSql += "select tt.nome empresa,  count(tt.cod_acao) qtd_acao FROM ("

        strSql += "select e.nome , f.cod_acao, e.cod_emitente, n.cod_negociacao_cliente, f.seq_follow_up, f.cod_usuario  "
        ...
        strSql += "select distinct e.nome , f.cod_acao, c.cod_emitente, f.cod_chamado, f.seq_follow_up, f.cod_usuario "
        ...
        End If
        strSql += " ) as tt"
        strSql += " group by tt.nome "
        strSql += " order by tt.nome"
