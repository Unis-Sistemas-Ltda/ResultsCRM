<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFRelSLAComparativoAgendamento.aspx.vb" Inherits="ResultsCRM.WFRelSLAComparativoAgendamento" %>
        ...
        <tr><td colspan="4">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="data_agendamento_sla" HeaderText="Previsto" 
                                SortExpression="data_agendamento_sla" 
                                DataFormatString="{0:dd/MM/yyyy HH:mm}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="data_agendamento" HeaderText="Realizado" 
                                SortExpression="data_agendamento" DataFormatString="{0:dd/MM/yyyy HH:mm}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="call sp_rel_sla_agendamento(:empresa, :cod_chamado, :cod_analista, :cod_emitente, :tipo_chamado, :nome_emitente, :ponto_atendimento, :agente_tecnico, :data_i, :data_f, :cod_regiao)">
                        <SelectParameters>
