<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFAvaliacaoDetalhes.aspx.vb" Inherits="ResultsCRM.WFAvaliacaoDetalhes" %>
            ...
            <td>
                <asp:Menu ID="MnuTabs" runat="server" Orientation="Horizontal" Font-Names="Verdana"
                    ...
                    <StaticMenuItemStyle ForeColor="#333333" BorderStyle="None" HorizontalPadding="5px"
                        VerticalPadding="5px" />
                    <Items>
                        <asp:MenuItem Text="Avaliação" Value="WFAvaliacao.aspx" Selected="True">
                        </asp:MenuItem>
                        <asp:MenuItem Text="Itens Avaliados" Value="WGAvaliacaoItem.aspx"></asp:MenuItem>
