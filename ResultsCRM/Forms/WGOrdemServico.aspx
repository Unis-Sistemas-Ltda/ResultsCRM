<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WGOrdemServico.aspx.vb" Inherits="ResultsCRM.WGOrdemServico" %>
...
<body style="padding: 0px; width: 100%; text-align: left; top: 0px; height: 100%; min-height: 100%; margin: 0px; clip: rect(auto auto auto auto)">
    ...
    <div class="TituloMovimento">
        Painel de Ordens de Serviço</div>
    <div>
...
&nbsp;<asp:DropDownList ID="ddlAnalista" runat="server" 
            ...
            <ajaxToolkit:MaskedEditExtender ID="TxtDataEncerramento_MaskedEditExtender" 
                ...
                <td style="text-align: right;">
                    <asp:Label ID="Label2" runat="server" Text="Status Recebimento:"></asp:Label>
                </td>
                <td style="vertical-align: top">
                ...
                <td style="text-align: right; vertical-align: bottom">
                    <asp:Label ID="Label13" runat="server" Height="16px" Text="Técnico(s):"></asp:Label>
&nbsp;<asp:TextBox ID="TxtTecnico" runat="server" CssClass="CampoCadastro" 
                        ToolTip="Informe o nome ou parte do nome do agente técnico" Width="190px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="text-align: right; ">
                ...
                <td style="text-align: right; vertical-align: bottom">
                    <asp:Label ID="Label12" runat="server" Height="16px" Text="Ponto Atendimento:"></asp:Label>
&nbsp;<asp:TextBox ID="TxtPontoAtendimento" runat="server" CssClass="CampoCadastro" 
                        ToolTip="Informe o nome ou parte do nome do cliente." Width="190px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td style="text-align: right; vertical-align: bottom">
                    <asp:Label ID="Label14" runat="server" Height="16px" 
                        Text="Região Atendimento:&nbsp;"></asp:Label>
            ...
            <tr>
                <td colspan="5">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="call sp_painel_os(:empresa, :ntop, :pedido, :status_digitacao, :status_recebimento, :cod_emitente, :cod_contato, :nome_emitente, :cod_analista, :ponto_atend, :data_encerramento, :tecnicos, :cod_regiao, :codemitenteexterno)">
                        <SelectParameters>
