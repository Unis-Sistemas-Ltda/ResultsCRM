<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WGOSCausa.aspx.vb" Inherits="ResultsCRM.WGOSCausa" %>
...
<body>
    ...
    <div class="TextoCadastro_BGBranco" 
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td>
                    Selecione abaixo a solicitação.</td>
            </tr>
            <tr>
                <td>
...
order by pi.seq_solicitacao">
            <SelectParameters>
                <asp:SessionParameter DefaultValue="" Name=":tpfat" 
