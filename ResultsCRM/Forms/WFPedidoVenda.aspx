<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFPedidoVenda.aspx.vb" Inherits="ResultsCRM.WFPedidoVenda" %>
    ...
    <form id="form1" runat="server" style="height:100%">
       ...
       <table style="width: 100%;">
        ...
        <asp:Menu ID="MnuTabs" runat="server" Orientation="Horizontal" Font-Names="Verdana" 
            ...
            <Items>
                <asp:MenuItem Text="Pedido" 
                    Value="WFOSCabecalho.aspx" Selected="True"></asp:MenuItem>
                <asp:MenuItem Text="Itens" Value="WGOSItem.aspx"></asp:MenuItem>
                ...
                <asp:MenuItem NavigateUrl="~/Forms/WGPedidoVenda.aspx" Text="Voltar" 
