<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFGrupoResultadoDetalhes.aspx.vb"
    Inherits="ResultsCRM.WFGrupoResultadoDetalhes" %>
    ...
    <table style="width: 100%; height: 100vh">
        <tr>
            <td class="TituloMovimento">
                Detalhe do Grupo de Resultado de Item Avaliado
            </td>
        </tr>
        <tr>
            <td>
                <asp:Menu ID="MnuTabs" runat="server" Orientation="Horizontal" Font-Names="Verdana"
                    ...
                    <StaticMenuItemStyle ForeColor="#333333" BorderStyle="None" HorizontalPadding="5px"
                        VerticalPadding="5px" />
                    <Items>
                        <asp:MenuItem Text="Grupo Resultado" Value="WFGrupoResultado.aspx" Selected="True">
                        </asp:MenuItem>
                        <asp:MenuItem Text="Resultados" Value="WGGrupoResultadoItem.aspx"></asp:MenuItem>
