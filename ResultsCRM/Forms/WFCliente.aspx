<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFCliente.aspx.vb" Inherits="ResultsCRM.WFCliente" %>
    ...
    <form id="form1" runat="server" style="height:100%">
       ...
       <table style="width: 100%;">
        ...
        <asp:Button ID="BtnVoltar" runat="server" Text="Voltar" CssClass="Botao" />
            ...
            <tr>
                <td style="border: thin ridge #CCCCCC; width: 45%; height: 495px">
                    <uc2:WUCFrame ID="FrameSuperior" runat="server" /></td>
                <td style="border: thin ridge #CCCCCC; width: 55%; height: 495px">
