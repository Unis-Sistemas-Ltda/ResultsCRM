<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WGClienteSLAEstadoCidade.aspx.vb" Inherits="ResultsCRM.WGClienteSLAEstadoCidade" %>
...
<body style="margin:0px">
    ...
    <div class="TextoCadastro_BGBranco">
        ...
        )&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; UF:<asp:Label ID="LblUF" runat="server"></asp:Label>
                </td>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            <Columns>
                <asp:BoundField DataField="sigla_estado" HeaderText="UF" 
                    SortExpression="sigla_estado" Visible="False">
                <HeaderStyle HorizontalAlign="Center" />
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="nome_cidade" HeaderText="Municípío" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT se.cod_pais cod_pais, se.cod_estado cod_estado, uf.sigla sigla_estado, ci.cod_cidade cod_cidade, ci.nome_cidade nome_cidade, se.prazo_chegada, se.prazo_encerramento, cod_pais || ';' || cod_estado || ';' || cod_cidade chave
  FROM sla_emitente_cidade se inner join estado uf on se.cod_pais = uf.cod_pais and se.cod_estado = uf.cod_estado
                              inner join cidade ci on se.cod_pais = ci.cod_pais and se.cod_estado = ci.cod_estado and se.cod_cidade = ci.cod_cidade
 WHERE se.cod_emitente = :cod_emitente
   AND se.cod_estado = :cod_estado
   AND se.cod_sla = :cod_sla
ORDER BY sigla_estado, nome_cidade, cod_cidade">
            <SelectParameters>
                <asp:SessionParameter Name="cod_emitente" SessionField="SCodEmitente" />
                <asp:SessionParameter Name="cod_estado" SessionField="SCodEstadoSLA" />
