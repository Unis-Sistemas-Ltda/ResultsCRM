<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFAtendimentoConsultaHistoricoPA.aspx.vb" Inherits="ResultsCRM.WFAtendimentoConsultaHistoricoPA" %>
...
<body>
    ...
    <div class="SubTituloMovimento" style="font-size: 8pt">Histórico do Ponto de Atendimento</div>
    <div>
        ...
        <table style="width:100%; font-size: 8pt;">
            ...
            <tr>
                ...
                <td style="font-size: 8pt;">
                    ...
                    <asp:TextBox ID="TxtPatrimonio" runat="server" 
                        CssClass="CampoCadastro" Width="150px"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Equipamento" SortExpression="numero_serie">
                    ...
                    <ItemTemplate>
                        ...
                        <br />
                        <b>Patrimônio</b><br />
                        <asp:Label ID="Label60" runat="server" Text='<%# Bind("numero_registro") %>'></asp:Label>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Serv. Realizado" SortExpression="narrativa">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("narrativa") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label5" runat="server" Text='<%# Bind("narrativa") %>'></asp:Label>
                        <br />
                        <br />
                        <b>Técnico(s)</b><br />
                        <asp:Label ID="Label40" runat="server" Text='<%# Bind("tecnicos") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left" />
                </asp:TemplateField>
...
order by p.cod_pedido_venda desc, pi.seq_item asc">
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="LblCodCliente" Name=":cod_emitente" 
                    PropertyName="Text" />
                <asp:ControlParameter ControlID="LblNumeroPontoAtendimento" 
                    Name=":numero_ponto_atendimento" PropertyName="Text" />
