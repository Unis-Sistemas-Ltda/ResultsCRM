<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WGSistema.aspx.vb" Inherits="ResultsCRM.WGSistema" %>
...
<body>
    ...
    <div style="text-align: right">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:BoundField DataField="cod_sistema" HeaderText="Código" ReadOnly="True" 
                    SortExpression="cod_sistema">
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton ID="ImageButton1" runat="server" 
                            CommandArgument='<%# Eval("cod_sistema") %>' CommandName="ALTERAR" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="select cod_sistema, descricao
   from sistema
