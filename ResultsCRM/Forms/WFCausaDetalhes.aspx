<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFCausaDetalhes.aspx.vb" Inherits="ResultsCRM.WFCausaDetalhes" %>
    ...
    <form id="form1" runat="server" style="height:100%">
       ...
       <table style="width: 100%; border-collapse: collapse;">
        ...
        <asp:Menu ID="MnuTabs" runat="server" Orientation="Horizontal" Font-Names="Verdana" 
            ...
            <Items>
                <asp:MenuItem Selected="True" Text="Causa" 
                    Value="WFCausa.aspx"></asp:MenuItem>
                <asp:MenuItem Text="Efeitos" Value="WGCausaEfeitos.aspx"></asp:MenuItem>
                <asp:MenuItem Text="Ações" 
                    Value="WGCausaAcoes.aspx">
                </asp:MenuItem>
                <asp:MenuItem Text="Voltar" 
                    Value="Voltar" NavigateUrl="WGCausa.aspx"></asp:MenuItem>
            </Items>
        </asp:Menu>
