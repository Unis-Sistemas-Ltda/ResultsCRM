<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WGClienteSLAEstadoRegiao.aspx.vb" Inherits="ResultsCRM.WGClienteSLAEstadoRegiao" %>
    ...
    <div class="TextoCadastro_BGBranco">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="nome_regiao" HeaderText="Região" 
                    SortExpression="nome_regiao">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT se.cod_pais cod_pais, se.cod_estado cod_estado, uf.sigla sigla_estado, se.cod_regiao, se.nome nome_regiao, se.prazo_chegada, se.prazo_encerramento, cod_pais || ';' || cod_estado || ';' || cod_regiao chave
  FROM sla_emitente_regiao se inner join estado uf on se.cod_pais = uf.cod_pais and se.cod_estado = uf.cod_estado
 WHERE se.cod_emitente = :cod_emitente
   AND se.cod_estado = :cod_estado
   AND se.cod_sla = :cod_sla
ORDER BY sigla_estado, nome_regiao, se.cod_regiao">
            <SelectParameters>
