<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFClienteSLAEstadoDetalhes.aspx.vb" Inherits="ResultsCRM.WFClienteSLAEstadoDetalhes" %>
...
<body style="margin:0px">
    ...
    <div>
        ...
        <asp:Menu ID="MnuTabs" runat="server" Orientation="Horizontal" Font-Names="Verdana" 
            ...
            <Items>
                <asp:MenuItem Text=" UF " 
                    
                    Value="WFClienteSLAEstado.aspx"></asp:MenuItem>
                <asp:MenuItem Text=" Região  " 
                    
                    Value="WGClienteSLAEstadoRegiao.aspx">
                </asp:MenuItem>
                <asp:MenuItem Text=" Município" Value="WGClienteSLAEstadoCidade.aspx">
                </asp:MenuItem>
            </Items>
        </asp:Menu>
        ...
        <asp:Button ID="BtnVoltar" runat="server" CssClass="Botao" Text="Voltar" />
            ...
            <tr>
                <td style="border: thin ridge #CCCCCC; width: 100%; height: 383px" colspan="2">
