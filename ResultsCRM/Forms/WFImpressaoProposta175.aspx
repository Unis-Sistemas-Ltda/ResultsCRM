<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFImpressaoProposta175.aspx.vb" Inherits="ResultsCRM.WFImpressaoProposta175" %>
    ...
    <table style="width:800px; font-family: Arial; font-size: 9pt; border-collapse: collapse;">
        <tr>
            <td colspan="3">
                <div style=" position: absolute; top: 20px; left: 12px">
                    <img alt="Proposta Comercial" 
                        
                        src="http://matriz.unissistemas.com.br/webdeskunis/imagens/logo-tecnoport.jpg" /></div>
            </td>
            <td style="width: 30%; text-align: center; vertical-align: top; font-style: normal;">
        ...
        <tr>
            <td colspan="4" style="text-align: left">
                <span style="font-size:12pt"><asp:Label ID="LblRazaoSocialEmpresa" 
                    runat="server" Font-Bold="True" Font-Size="14pt"></asp:Label></span>
                <br />
                CNPJ:
        ...
        <tr>
            <td colspan="4" style="font-style: normal; font-weight: bold; font-size: 14pt;">
                A</td>
        </tr>
        <tr>
            <td style="font-style: normal; font-weight: bold; font-size: 15pt;">
                <asp:Label ID="LblRazaoSocial" runat="server" Font-Bold="True" Font-Size="14pt"></asp:Label>
            </td>
            <td style="font-style: normal; font-size: 9pt;" colspan="3">
                CNPJ/CPF:
                <asp:Label ID="LblCNPJ" runat="server" Font-Bold="False"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="font-style: normal; font-size: 9pt;">
        ...
        <tr>
            <td colspan="2" style="font-style: normal; font-size: 9pt;">
                Representante:
        ...
        <tr>
            <td colspan="4" style="font-style: normal; font-weight: bold; font-size: 9pt;">
                <br />
        ...
        <tr>
            <td colspan="4" 
                ...
                style="padding: 5px; border-style: none; border-width: 0px; font-weight: bold; font-size: 14pt; font-style: normal;">
        ...
        <tr>
            <td colspan="2" style="font-style: normal; font-weight: bold; font-size: 9pt;">
                <br />
                Forma de Pagamento:
        ...
        <tr>
            <td colspan="2" style="font-size: 9pt; font-weight: bold; font-style: normal">
                &nbsp;</td>
            <td colspan="2" style="font-style: normal; font-weight: bold; font-size: 9pt;">
        ...
        <tr>
            <td colspan="2" style="font-size: 9pt; font-weight: bold; font-style: normal;">
                &nbsp;</td>
            <td colspan="2" style="font-style: normal; font-weight: bold; font-size: 9pt;">
                <asp:Label ID="Label8" runat="server" Text="ICMS Substituição:" Width="185px" style="text-align: right"></asp:Label>
        ...
        <tr>
            <td colspan="2" style="font-size: 9pt; font-weight: bold; font-style: normal;">
                &nbsp;</td>
            <td colspan="2" style="font-style: normal; font-weight: bold; font-size: 9pt;">
                <asp:Label ID="Label9" runat="server" Text="Total:" Width="185px" 
        ...
        <tr>
            <td colspan="4" 
                style="text-align: justify; font-size: 9pt; font-weight: bold; font-style: normal;">
                <br />
        ...
        <tr>
            <td colspan="4" style="font-style: normal; font-weight: bold;">
