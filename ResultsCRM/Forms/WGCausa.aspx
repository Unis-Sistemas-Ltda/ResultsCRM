<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WGCausa.aspx.vb" Inherits="ResultsCRM.WGCausa" %>
...
<body>
    ...
    <div style="text-align: right">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:BoundField DataField="cod_causa" HeaderText="Código" ReadOnly="True" 
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton ID="ImageButton1" runat="server" 
                            CommandArgument='<%# Eval("cod_causa") %>' CommandName="ALTERAR" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="select cod_causa, descricao
   from causa
