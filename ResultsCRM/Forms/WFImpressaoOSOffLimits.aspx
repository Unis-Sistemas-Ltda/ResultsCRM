<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFImpressaoOSOffLimits.aspx.vb" Inherits="ResultsCRM.WFImpressaoOSOffLimits" %>
...
&nbsp;/
            ...
            <tr>
                <td colspan="4" style="text-align: center; font-weight: bold; font-size: 11pt">
                    ORDEM DE SERVIÇO</td>
            ...
            <tr>
                <td colspan="4" style="text-align: left; font-size: 10pt" rowspan="5">
...
&nbsp;/
                    ...
                    <asp:GridView ID="GridView1" runat="server" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Equipamento / Serviço Solicitado" 
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("cf_item_descricao") %>'></asp:Label>
                ...
                <td colspan="6">
                    <asp:GridView ID="GridView2" runat="server" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Valor Total" SortExpression="valor_mercadoria">
                                <ItemTemplate>
                                    <asp:Label ID="LblValorTotalItem" runat="server" 
                                        Text='<%# Bind("valor_mercadoria", "R$ {0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
            ...
            <tr>
                <td colspan="3" style="line-height: 21px; vertical-align: bottom;">
                    Valor Total:</td>
                <td colspan="3" 
                    style="line-height: 21px; vertical-align: bottom; text-align: right;">
                    R$<asp:Label ID="LblValorTotal" 
                        runat="server" Width="73px" style="text-align=right">0,00</asp:Label>
&nbsp;</td>
            </tr>
            <tr>
                <td colspan="6" style="line-height: 21px; vertical-align: bottom;">
                    Observações:_____________________________________________________________________________________________</td>
            </tr>
            <tr>
                <td colspan="6" style="height: 18px; vertical-align: bottom">
                                        &nbsp;
            ...
            <tr>
                <td colspan="6" style="line-height: 3px">
                    &nbsp;</td>
            </tr>
            <tr>
