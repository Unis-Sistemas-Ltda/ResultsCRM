<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFAprovFinancOSDetalhes.aspx.vb" Inherits="ResultsCRM.WFAprovFinancOSDetalhes" %>
    ...
    <form id="form1" runat="server" style="height:100%">
       ...
       <table style="width: 100%;">
        ...
        <asp:Menu ID="MnuTabs" runat="server" Orientation="Horizontal" Font-Names="Verdana" 
            ...
            <Items>
                <asp:MenuItem Text="&nbsp;Serviços Realizados&nbsp;&nbsp;" 
                    Value="WGAprovFinancOSDetalheItem.aspx"></asp:MenuItem>
                <asp:MenuItem Text=" Agentes Técnicos&nbsp;" 
                    Value="WGOSAgenteTecnico.aspx?tt=2"></asp:MenuItem>
<asp:MenuItem Text="Itens Solicitados&nbsp;" Value="WGOSSolicitacao.aspx"></asp:MenuItem>
                <asp:MenuItem Text="&nbsp;Histórico Ponto Atend." 
                    Value="WFAprovFinancOSHistoricoPA.aspx"></asp:MenuItem>
            </Items>
        </asp:Menu>
