<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WGTipoAvaliacao.aspx.vb" Inherits="ResultsCRM.WGTipoAvaliacao" %>
...
<body>
    ...
    <div class="TituloCadastro">
        Cadastro de Tipos de Avaliação</div>
    <div>
    ...
    <div style="text-align: right">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" EmptyDataText="Nenhum registro foi cadastrado até o momento."
            ...
            <Columns>
                <asp:BoundField DataField="cod_tipo_avaliacao" HeaderText="Código" ReadOnly="True" 
                    SortExpression="cod_tipo_avaliacao">
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton ID="ImageButton1" runat="server" 
                            CommandArgument='<%# Eval("cod_tipo_avaliacao") %>' CommandName="ALTERAR" 
                            ImageUrl="~/Imagens/BtnEditar.png" ToolTip="Detalhes do Registro" />
                        &nbsp;<asp:ImageButton ID="ImageButton2" runat="server" 
                            CommandArgument='<%# Eval("cod_tipo_avaliacao") %>' CommandName="EXCLUIR" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="select cod_tipo_avaliacao, descricao
   from tipo_avaliacao
 where empresa = :empresa
 order by cod_tipo_avaliacao">
            <SelectParameters>
