<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFRoteiroVisitaDetalhes.aspx.vb" Inherits="ResultsCRM.WFRoteiroVisitaDetalhes" %>
            ...
            <td style="padding: 0px; margin: 0px; border-style: solid none solid none; border-width: 1px;
                ...
                <asp:Menu ID="MnuTabs" runat="server" Orientation="Horizontal" Font-Names="Verdana"
                    ...
                    <StaticMenuItemStyle ForeColor="#333333" BorderStyle="None" HorizontalPadding="5px"
                        VerticalPadding="5px" />
                    <Items>
                        <asp:MenuItem Selected="True" Text="Roteiro" Value="WFRoteiroVisita.aspx"></asp:MenuItem>
                        <asp:MenuItem NavigateUrl="WGRoteiroVisita.aspx" Text="Voltar" Value="Voltar">
                        </asp:MenuItem>
                    </Items>
                </asp:Menu>
            </td>
