<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WGEfeito.aspx.vb" Inherits="ResultsCRM.WGEfeito" %>
...
<body>
    ...
    <div style="text-align: right">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:BoundField DataField="cod_efeito" HeaderText="Código" ReadOnly="True" 
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton ID="ImageButton1" runat="server" 
                            CommandArgument='<%# Eval("cod_efeito") %>' CommandName="ALTERAR" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="select cod_efeito, descricao
   from efeito
