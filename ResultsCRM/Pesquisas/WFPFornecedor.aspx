<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFPFornecedor.aspx.vb" Inherits="ResultsCRM.WFPFornecedor" %>
    ...
    <link href="../ResultsCRMAjax.css" rel="stylesheet" type="text/css" />
     <script language="javascript" type="text/javascript">
         function getbacktostepone() {
             window.location = "WFPFornecedor.aspx";
         }
         function onSuccess() {
                ...
                style="width: 350px; height: 390px; font-size: 7pt; background-color: #FFFFFF;">
                    <tr>
                        <td class="TituloConsulta" colspan="3" style="height: 20px">
                            Pesquisa de Fornecedores</td>
                    </tr>
                    <tr>
                        <td style="height: 25px">
                            <asp:Label ID="LblFornecedor" runat="server" 
                                Text="Informe o nome ou parte do nome do fornecedor:"></asp:Label>
                        </td>
