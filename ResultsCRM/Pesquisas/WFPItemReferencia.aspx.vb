Partial Public Class WFPItemReferencia
    ...
    Protected Sub TxtFornecedor_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtValor.TextChanged
