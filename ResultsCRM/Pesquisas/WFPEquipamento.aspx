<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFPEquipamento.aspx.vb" Inherits="ResultsCRM.WFPEquipamento" %>
     ...
     <asp:MultiView ID="MultiViewExpanse" runat="server">
        <asp:View ID="ViewInput" runat="server">
            <table class="TextoCadastro" 
                style="width: 350px; height: 340px; font-size: 7pt;">
                <tr>
                ...
                <tr>
                    ...
                    <td class="CelulaCampoCadastro" style="width: 100px">
                ...
                <tr>
                    <td colspan="4" style="vertical-align: top">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ...
                            ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="select numero_serie, numero_serie || ' - ' || observacao || ' (' || numero_registro || ')' descricao
  from equipamento
 where empresa     = :empresa
   and cod_cliente = :cod_cliente
   and numero_ponto_atendimento = :numero_ponto_atendimento
