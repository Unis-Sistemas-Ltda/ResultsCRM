Public Class UCLCidade
    ...
    Public Function DtCidadePorDescricao(ByVal pBuscaDescricao As String, ByVal pBuscaCodEstado As String) As DataTable
        Try
            Dim dt As DataTable

            Dim strSql As String = " select cod_pais || ';' || cod_estado || ';' || cod_cidade chave, upper(nome_cidade) nome_cidade from cidade where nome_cidade like '%" + pBuscaDescricao.Trim + "%' and cod_estado = " + pBuscaCodEstado + " order by nome_cidade "
            dt = ObjAcessoDados.BuscarDados(strSql)
