Public Class UCLCondicaoPagamento
    ...
    Public Property PercDescontoPadrao As String
    ...
    Public Function Buscar() As Boolean
        ...
        StrSql += " select cod_cond_pagto, descricao, isnull(perc_desconto_padrao,0) perc_desconto_padrao "
        ...
        If dt.Rows.Count > 0 Then
            ...
            PercDescontoPadrao = dt.Rows.Item(0).Item("perc_desconto_padrao").ToString
            Return True
        Else
            Return False
        End If
