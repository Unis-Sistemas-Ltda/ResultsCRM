Public Class UCLPedidoVendaSolicitacaoEquipamentoComponente
    ...
    Public Function Existe() As Boolean
        Try
            ...
            StrSql += "   from pedido_venda_solicitacao_equipamento_componente "
    ...
    Public Sub Incluir()
        Try
            ...
            StrSql += " insert into pedido_venda_solicitacao_equipamento_componente ( "
            StrSql += "    empresa, "
    ...
    Public Sub Excluir()
        Try
            Dim StrSql As String
            StrSql = " call sp_sysvar();"
            StrSql += " delete from pedido_venda_solicitacao_equipamento_componente "
            StrSql += "  where empresa           = " + Empresa
            StrSql += "    and estabelecimento   = " + Estabelecimento
            StrSql += "    and cod_pedido_venda  = " + CodPedidoVenda
            StrSql += "    and seq_solicitacao   = " + SeqSolicitacao
