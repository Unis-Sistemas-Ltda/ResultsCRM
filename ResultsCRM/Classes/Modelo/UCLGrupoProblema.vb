Public Class UCLGrupoProblema
    Inherits UCLClasseGenerica

    Public Sub New()
        ObjTabelaGenerica = New UCLTabelaGenerica("grupo_problema")
    End Sub
    ...
    Public Function GetProximoCodigo(ByVal pEmpresa As String) As Long
        Try
            Dim StrSql As String = " select isnull(max(cod_grupo),0) + 1 seq from grupo_problema where empresa = " + pEmpresa
    ...
    Public Sub FillDropDown(ByRef DDL As DropDownList, ByVal pEmpresa As String, ByVal AdicionarRegistroEmBranco As Boolean, ByVal DescricaoRegistroEmBranco As String, ByVal CodRegistroEmBranco As String)
        ...
        strSql += " select cod_grupo, descricao "
        strSql += "   from grupo_problema"
        ...
        If AdicionarRegistroEmBranco Then
            ...
            NovaLinha("cod_grupo") = CodRegistroEmBranco
