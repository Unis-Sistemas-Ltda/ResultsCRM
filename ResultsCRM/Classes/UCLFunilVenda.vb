Public Class UCLFunilVenda
    ...
    Public Sub FillDropDownCompleta(ByRef DDL As DropDownList, ByVal AdicionarRegistroEmBranco As Boolean, ByVal DescricaoRegistroEmBranco As String, ByVal pEmpresa As String)
        Dim strSql As String = ""
        Dim dt As DataTable
