    ...
    Public Function Buscar() As DataTable
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                PercAcrescimoUnitario = dt.Rows.Item(0).Item("perc_acrescimo_unitario").ToString
                PrecoUnitarioTabela = CDbl(dt.Rows.Item(0).Item("preco_unitario_tabela").ToString).ToString("F4")
