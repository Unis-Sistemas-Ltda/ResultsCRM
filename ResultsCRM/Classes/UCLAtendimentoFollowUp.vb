Public Class UCLAtendimentoFollowUp
    ...
    Public Sub Incluir()
        ...
        Try
            ...
            strSql = " insert into follow_up_chamado (empresa, cod_chamado, seq_follow_up, cod_usuario, data_follow_up, descricao, email, data_email, tipo, cod_acao) "
            strSql += " values ( " + Empresa + ", " + CodChamado + "," + SeqFollowUP + ", " + CodUsuario + ", " + dbDataFollowUp + ", '" + Descricao + "', '" + Email + "', " + dbDataEmail + ", '" + Tipo + "', " + CodAcao + ")"
    ...
    Public Sub Excluir()
        Try
            ...
            strSql += " delete from follow_up_chamado "
            strSql += "  where empresa       = " + Empresa
            strSql += "    and cod_chamado   = " + CodChamado
            strSql += "    and seq_follow_up = " + SeqFollowUP
    ...
    Public Function EnviaEmailFollowUP(ByVal strConn As String) As String
        Try
            ...
            strSql = " select f_nome_arquivo(arquivo) arquivo"
            ...
            objParametrosManutencao.Buscar(Empresa, 1)
            For Each row As DataRow In dt.Rows
                arquivo = row.Item("arquivo")
                FileCopy(objParametrosManutencao.GetConteudo("caminho_anexo_follow_up") + "\" + arquivo, objParametrosManutencao.GetConteudo("caminho_anexo_email") + "\" + arquivo)
            Next
