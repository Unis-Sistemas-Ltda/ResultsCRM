Public Class UCLPortador
    ...
    Public Sub FillDropDown(ByRef DDL As DropDownList, ByVal AdicionarRegistroEmBranco As Boolean, ByVal DescricaoRegistroEmBranco As String)
        ...
        strSql += " select cod_portador, descricao || ' (' || cod_portador || ')' as descricao "
        strSql += "   from portador "
        ...
        DDL.DataValueField = "cod_portador"
        DDL.DataBind()
    End Sub
