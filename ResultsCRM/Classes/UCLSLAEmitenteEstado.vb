Public Class UCLSLAEmitenteEstado
    ...
    Public Sub Incluir()
        ...
        Try
            ...
            strSql += " insert into sla_emitente_estado (cod_sla, cod_emitente, cod_pais, cod_estado, prazo_chegada, prazo_encerramento) "
            strSql += " values ( " + CodSLA + ", " + CodEmitente + ", " + CodPais + ", " + CodEstado + ", " + PrazoChegada + ", " + PrazoEncerramento + ") "
    ...
    Public Sub Alterar()
        ...
        Try
            ...
            strSql += " update sla_emitente_estado set prazo_chegada = " + PrazoChegada + ", prazo_encerramento = " + PrazoEncerramento
    ...
    Public Function Buscar() As Boolean
        ...
        StrSql += "   from sla_emitente_estado "
        StrSql += "  where cod_sla      = " + CodSLA
        StrSql += "    and cod_emitente = " + CodEmitente
        StrSql += "    and cod_pais     = " + CodPais
        StrSql += "    and cod_estado   = " + CodEstado
